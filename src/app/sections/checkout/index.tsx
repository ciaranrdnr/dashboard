  ...
  return (
    <section className="checkout flex relative mt-24 b-0 sm:pb-40  sm:min-h-screen">
      ...
      <div className="flex sm:flex-row flex-col items-center sm:space-x-14 px-[10%]">
        <h3 className="text-navy text-3xl sm:w-1/2 sm:text-5xl sm:leading-[72px] text-left font-semibold">
              ...
              <div className="flex flex-col space-y-8">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-4">
                    <p className="font-semibold text-blue">-</p>
                    <p>50</p>
                    <p className="font-semibold text-blue">+</p>
                  </div>
                </div>
                <Button
                  ...
                  className="font-semibold py-[9px]"
                />
              </div>
            </div>
            <InteractiveArrow className="text-black/50" color="#bbbbbb" />
          </div>
          <Image className="z-0" src={"/bg-checkout.png"} alt="" fill />
        </div>
      </div>
    </section>
  );
